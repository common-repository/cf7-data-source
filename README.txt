...
Tags: cf7, contact form 7, database, data source, CSV
...
* Adds new predefined DB queries to retrieve posts and pages with specific text on titles or contents.

= 1.2.0 =

* Includes Order by attributes in the Taxonomy, Posts, and Users data sources to allow sorting records easily.

= 1.1.25 =

* Includes new predefined user-related queries.

= 1.1.24 =

* Includes a new predefined for filtering the users' list by role.
* Reimplement the load language process to ensure compatibility with WP6.7

= 1.1.23 =

* Includes predefined queries load the list of posts associated with a category or custom taxonomy term.

= 1.1.22 =

* Modifies the RecordSet control to display a new button in the insertion dialog to insert the RecordSet tag only beside the button that inserts the field tag and opens the recordset-field-link insertion popup.
* Includes a new predefined query load the list of posts associated with a tag.
* Fixes an issue opening the recordset-field-link settings.

= 1.1.21 =

* Fixes a minor issue identifying the RecordSet controls in the DataTable controls.
* Includes new predefined queries.

= 1.1.20 =

* Set Database as the default data source because it covers other options like users, posts, and taxonomies.
* Reimplement the predefined queries section to allow the list of queries to grow and be organized.

= 1.1.19 =

* Improves the user experience by including a video tutorial in the plugin interface.
