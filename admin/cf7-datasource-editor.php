	...
	class CF7_DATASOURCE_EDITOR {
		...
		private function admin_resources() {
			...
			wp_localize_script(
				...
				array(
					...
					'textWrapping' => false,
					'btnText'	   => esc_attr__( 'Insert & open dialog', 'cf7-datasource' ),
					'btnTitle'	   => esc_attr__( 'Insert the recordset tag and open the field-link dialog', 'cf7-datasource' ),
					'btn2Text'	   => esc_attr__( 'Insert only', 'cf7-datasource' ),
					'btn2Title'	   => esc_attr__( 'Insert the recordset tag', 'cf7-datasource' ),
				)
			);
		} // End js
		...
		public function tag_generator_recordset( $contact_form, $args = '' ) {
			...
			<div class="control-box cf7-datasource-recordset">
				<fieldset>
					<legend><img title="<?php esc_attr_e('Video Tutorial', 'cf7-datasource'); ?>" id="cf7-ds-video-tutorial" src="data:image/svg+xml;base64," width="50px" align="left" style="margin-right:20px;cursor:pointer;"><?php _e( 'Generate a form-tag for a Recordset Field to read data from sources like user data, posts, taxonomies, and databases. <b><i>(Pro version supports ACF, CSV, server-side functions, and JSON files)</i></b>', 'cf7-datasource' ); // phpcs:ignore WordPress.Security.EscapeOutput
					?>
							...
							<tr class="cf7-datasource">
								...
								<td>
									...
									if (
										...
										print ': '.esc_html( $error_logs_path );
									}
									?></i></label><br /><br />
									<label><?php esc_html_e( 'I want to receive the error logs via email', 'cf7-datasource' ); ?></label>
									<input aria-label="<?php esc_attr_e( 'debugging email', 'cf7-datasource' ); ?>" type="email" name="cf7-debugging-email" value="" />
								</td>
							</tr>
						</tbody>
					</table>
			...
			<div class="insert-box" style="display:flex;overflow:hidden;">
				<input type="text" name="<?php echo esc_attr( $type ); ?>" class="tag code" readonly="readonly" onfocus="this.select();" style="margin-right:5px;" />
